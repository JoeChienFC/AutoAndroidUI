...
from internal.infra.pages.create_spot_publish_location import CreateSpotPublishLocation
...
def go_to_create_spot_publish_location():
    ADBClient.start_playsee_app().spot_click().icon_create_click().second_item_select_click()
    CreateSpotUploadAlbum().btn_select_click().textbar_location_click()

    return CreateSpotPublishLocation()


def test_text_done_click():
    event_name = "text_done_click"
    go_to_create_spot_publish_location().text_done_click()
...
def test_bar_search_click():
    ...
    go_to_create_spot_publish_location().bar_search_click()
...
def test_bar_search_typing():
    ...
    go_to_create_spot_publish_location().bar_search_typing()
...
def test_icon_my_location_click():
    event_name = "icon_my_location_click"
    go_to_create_spot_publish_location().icon_my_location_click()
...
def test_list_location_click():
    ...
    go_to_create_spot_publish_location().list_location_click()
...
def test_text_no_result_show():
    ...
    go_to_create_spot_publish_location().text_no_result_show()
