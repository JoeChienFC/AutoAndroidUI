...
class CreateCommentUploadAlbum:
    ...
    def __init__(self):
        ...
        self.text_btn_select_x_y = (0.788, 0.887)
    ...
    def pic_profile_video_click(self):
        try:
            ...
            print(f"點 pic_profile_video 失败: {e}")
            pytest.xfail("點 pic_profile_video 失败")

    def text_btn_select_click(self):
        try:
            self.d.click(*self.text_btn_select_x_y)
            time.sleep(1)
